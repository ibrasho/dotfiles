...
# $HOME/.dotfiles/osx/set-defaults.sh — http://mths.be/osx
#

# Set computer name
COMPUTERNAME="Ibrahim's MBP"
HOSTNAME='ibrahim-mbp'
LOCALHOSTNAME='ibrahim-mbp'
...
# Disable some menu bar icons: Time Machine and User
for domain in $HOME/Library/Preferences/ByHost/com.apple.stytemuiserver.*; do
...
# Set language and text formats. (SAR and Metric Units)
defaults write -g AppleLanguages -array "en-SA"
defaults write -g AppleLocale -string "en_SA@calendar=gregorian"
